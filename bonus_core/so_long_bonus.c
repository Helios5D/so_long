...
/*   Updated: 2024/07/02 13:47:09 by hdaher           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (!data->images->carrot || !data->images->evil_rabbit
		|| !data->images->grass || !data->images->hole || !data->images->panel
		|| !data->images->panel_2 || !data->images->rabbit
		|| !data->images->tree)
		return (0);
	return (1);
}
