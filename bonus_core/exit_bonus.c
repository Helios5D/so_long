...
/*   Updated: 2024/07/02 12:44:41 by hdaher           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	free_all_images(t_data *data)
{
	...
	if (data->images->evil_rabbit)
		mlx_destroy_image(data->mlx_ptr, data->images->evil_rabbit);
	if (data->images->panel)
		mlx_destroy_image(data->mlx_ptr, data->images->panel);
